...
export default class Reports extends Component {
    ...
    componentDidMount() {
        fetch(`${url}/foreignCountries`).then(res => res.json())
            .then(res => {
                res.map(t => {
                    this.setState({
                        data: res,
    ...
    render() {
        const View =
            ...
            this.state.data.map((t )=> {
                ...
                return (
                    <MaterialUI.Paper style={{lineHeight:.5, width: window.innerWidth>800?window.innerWidth*.6:window.innerWidth, margin: 0 }} className="statusBoard" elevation={1}>
                        ...
                        <center>
                            <div style={{ display: 'flex', margin: 0 }}>
                                <div style={{
                                    ...
                                    <b
                                        style={{ fontSize: 20,lineHeight:0, color: "#3792cf" }}
        ...
        return (
            <>
                {this.state.isConnected === true ?<center>{View}<br/>
