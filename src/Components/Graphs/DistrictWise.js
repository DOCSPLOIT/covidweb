...
export default class DistrictWise extends Component{
    constructor(props){
        ...
        colors:['#008ffb', '#35dd81', '#dd3535','#19ee1f','#10ddcc','#d610dd','#e99999','#30e073','#dde030','#106e34','#ff9900',"#ce245c",'#75eaee','#354fe7','#3bd100']
          }
    ...
    render(){    
        return(
            <Chart  options={this.state.options} series={this.state.series} width={700} type="donut"  />
        )
    }
}